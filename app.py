...
BOT_TOKEN = os.getenv("8680676363:AAFo6QTuNP9vhUnZ5XstHC8SyTbFiT9DP90")

# === আপনার নিজের টেলিগ্রাম চ্যাট আইডি এখানে বসান ===
YOUR_CHAT_ID = "5293614793"
...
def fetch_trends(geo="BD"):
    ...
    for entry in feed.entries[:5]:
        ...
        trends.append(f"🔥 {title} (সার্চ: {traffic})")
    return "\n".join(trends) if trends else "এখন কোনো ট্রেন্ড নেই।"

async def start(update, context):
    """বটে /start দিলে এই ফাংশন চলবে"""
    await update.message.reply_text(
        "হ্যালো! আমি ট্রেন্ড অ্যালার্ট বট।\n"
        "ট্রেন্ড দেখতে /trends লিখুন।"
    )

async def trends_command(update, context):
    """বটে /trends দিলে এই ফাংশন চলবে"""
    await update.message.reply_text("ট্রেন্ড আনা হচ্ছে...")
    trend_text = fetch_trends()
